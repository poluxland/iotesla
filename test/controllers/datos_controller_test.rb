...
class DatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dato" do
    assert_difference("Dato.count") do
      post datos_url, params: { dato: { field1: @dato.field1, field2: @dato.field2, field3: @dato.field3, field4: @dato.field4, field5: @dato.field5, field6: @dato.field6 } }
    end
  ...
  test "should update dato" do
    patch dato_url(@dato), params: { dato: { field1: @dato.field1, field2: @dato.field2, field3: @dato.field3, field4: @dato.field4, field5: @dato.field5, field6: @dato.field6 } }
